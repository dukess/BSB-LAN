...
// Version 1 (parameters which can be changed by URL commands)
  ...
  CF_AVERAGESLIST, //Size (4 + 1) * 40 bytes. Array of prognrs 1-65535. prognr 0 will be ignored
  CF_LOGCURRINTERVAL, //Size 4 bytes. Unsigned. logging current values interval in seconds
  CF_CURRVALUESLIST, //Size (4 + 1) * 40 bytes. Array of prognrs 1-65535. prognr 0 will be ignored
// Version 2 (Web-config)
  ...
  CF_IPWEVALUESLIST, //Size (4 + 1) * 40 bytes. Array of prognrs 1-65535. prognr 0 will be ignored
